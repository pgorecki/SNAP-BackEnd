...
class UsersMe(APIView):
    ...
    def get(self, request):
        ...
        perms = map(
            lambda p: "{}.{}".format(p.content_type.app_label, p.codename), permissions
        )
        ...
        content = {
            ...
            and AgencyReader(request.user.profile.agency).data,
        }
...
class DashboardSummary(APIView):
    ...
    def get(self, request):
        content = {
            ...
            "responses": request.ability.queryset_for("view", SurveyResponse)
            .distinct()
            .count(),
