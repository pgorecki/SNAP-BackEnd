...
class SecurityGroup(models.Model):
    ...
    responses = models.BooleanField(
        default=False,
        verbose_name="Access Responses",
        help_text="Grants access to responses created by any of the agencies within the security group",
    )
    enrollments = models.BooleanField(
        default=False, verbose_name="Access Client enrollment data"
    )
    referrals = models.BooleanField(
        default=False, verbose_name="Access Client referral data"
    )
